...
API developed in NestJS for managing a product catalog. The API allows businesses, events, products, or services management using TypeORM and PostgreSQL, with JWT authentication, real-time notifications via Socket.IO, Cloudinary to upload images and Swagger documentation.
